...
# RAG Retrieval Architectures: Index-based vs. Embedding-based
...
## 1. Embedding-based RAG (Vector Search)
...
## 2. Index-based RAG (Keyword/Lexical Search)
...
## The Modern Standard: Hybrid RAG
